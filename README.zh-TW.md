...
Session 會結束，工作不會。中間那段空白，就是 Relay Kit 要補的洞——離開前收乾淨、把只活在對話
裡的東西寫下來、然後在另一頭接得回去。
...
一言以蔽之：**接手的人看不到你的對話，他只讀得到磁碟。**

這句話聽起來像廢話，但它的後果不是。你這個 session 累積的東西，會被這條線切成兩半，而且只有
一半活得下來：
...
每一次痛苦的交接，故事都長一樣：揮發層掉了，於是下一個 session 把定案的決策重吵一次，或者
一頭撞進你早就走過、也早就知道走不通的那條死路。

那漏水的是哪一端呢？你可能會想說是「到機」那端沒接好。其實不是，**通常在離機那端就已經漏了**
